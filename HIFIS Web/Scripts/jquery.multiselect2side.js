...
//                var nameDx = originalName + "ms2side__dx";
                ...
                var nameSx = "AvailableSide";
                var nameDx = "SelectedSide";
                ...
                //						"</div>";
                var divUpDown = "<div class='ms2side__updown'></div>";
...
//							((o.labelsx || leftSearch != false) ? ("<div class='ms2side__header color-accent'>" + (leftSearch != false ? leftSearch : o.labelsx) + "</div>") : "") +
//							"<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple' class='AvailableSP'></select>" +
//						"</div>" +
...
//						"</div>" +
//						"<div class='ms2side__select'>" +
//							((o.labeldx || rightSearch != false) ? ("<div class='ms2side__header color-accent'>" + (rightSearch != false ? rightSearch : o.labeldx) + "</div>") : "") +
//							"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' class='SelectedSP' ></select>" +
//						"</div>" +
//						((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
                //					"</div>";
                ...
                var htmlToAdd =
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							((o.selectedPosition == 'right')
							?
							("<input id='AddOne' type='button' class='AddOne' value='>' style='width:40px'></input>" +
							"<input id='AddAll' type='button' class='AddAll' value='>>' style='width:40px'></input>" +
							"<input id='RemoveOne' type='button' class='RemoveOne' value='<' style='width:40px'></input>" +
							"<input id='RemoveAll' type='button' class='RemoveAll' value='<<' style='width:40px'></input>")
							:
							("<p class='AddOne' title='Add Selected'>&lsaquo;</p>" +
							"<p class='AddAll' title='Add All'>&laquo;</p>" +
							"<p class='RemoveOne' title='Remove Selected'>&rsaquo;</p>" +
...
//                el.after(htmlToAdd);
                ...
                if (o.optGroupSearch != false) {
                    ...
                    el.children("optgroup").each(function () {
                        if (searchSelect.find("[value='" + $(this).attr("label") + "']").length == 0)
                ...
                $(this).next().find('.ms2side__options').each(function () {
                    var top = ((heightDiv / 2) - ($(this).height() / 2));
                    if (top > 0)
                        $(this).css('padding-top', top + 'px');
                })
                ...
                $(this).next().find('.ms2side__options').children().hover(
					function () {
					    $(this).addClass('ms2side_hover');
					},
					function () {
